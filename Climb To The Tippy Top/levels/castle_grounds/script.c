...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_STAR, 0, 16811, 0, 0, 0, 0, 0x00000000, bhvGrandStar),
		OBJECT(MODEL_NONE, 1998, 5626, 708, 0, 0, 0, (0x01 << 24), bhvStar),
		OBJECT(MODEL_NONE, -1418, 7861, -3412, 0, 0, 0, (0x384 << 24), bhvStar),
